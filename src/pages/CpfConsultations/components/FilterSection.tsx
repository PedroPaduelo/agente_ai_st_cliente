    ...
    <Card className="mb-4 p-4 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row gap-4 flex-wrap">
        ...
        <div className="flex items-end space-x-3 min-w-[200px]">
          <Button 
            ...
            disabled={!telefoneFilter && !cpfFilter && !agenteFilter && !sessionFilter && !dateFromFilter && !dateToFilter}
      ...
      {isFiltering && (
        <div className="mt-4 text-sm flex flex-wrap gap-2">
          ...
          {cpfFilter && <span className="mr-2 px-2 py-1 bg-muted rounded-md">CPF: {cpfFilter}</span>}
